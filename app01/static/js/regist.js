...
function checkUsername() {
    ...
    if (flag) {
        //提示绿色对勾
        s_username.innerHTML = "<img src='/static/images/gou.png' width='35' height='25'>";
    } else {
        //提示红色错误信息
...
function checkRePassword(){
    ...
    if(repassword===password && repassword!=""){
        //提示绿色对勾
        s_repassword.innerHTML = "<img width='35' height='25' src='/static/images/gou.png'/>";
        return true
    }else{
        //提示红色错误信息
...
function checkEmail(){
    ...
    if(flag){
        //提示绿色对勾
        s_email.innerHTML = "<img width='35' height='25' src='/static/images/gou.png'/>";
    }else{
        //提示红色错误信息
...
function checkRename(){
    ...
    if(flag){
        //提示绿色对勾
        s_rename.innerHTML = "<img width='35' height='25' src='/static/images/gou.png'/>";
    }else{
        //提示红色错误信息
...
function checkTelphone(){
    ...
    if(flag){
        //提示绿色对勾
        s_telphone.innerHTML = "<img width='35' height='25' src='/static/images/gou.png'/>";
    }else{
        //提示红色错误信息
